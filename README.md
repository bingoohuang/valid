Package validator
================
<img align="right" src="https://raw.githubusercontent.com/bingoohuang/valid/logo.png">[![Join the chat at https://gitter.im/bingoohuang/valid](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/bingoohuang/valid?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
![Project status](https://img.shields.io/badge/version-10.3.0-green.svg)
[![Build Status](https://travis-ci.org/bingoohuang/valid.svg?branch=master)](https://travis-ci.org/bingoohuang/valid)
[![Coverage Status](https://coveralls.io/repos/bingoohuang/valid/badge.svg?branch=master&service=github)](https://coveralls.io/github/bingoohuang/valid?branch=master)
[![Go Report Card](https://goreportcard.com/badge/github.com/bingoohuang/valid)](https://goreportcard.com/report/github.com/bingoohuang/valid)
[![GoDoc](https://godoc.org/github.com/bingoohuang/valid?status.svg)](https://pkg.go.dev/github.com/bingoohuang/valid)
...
-   Default validator for the [gin](https://github.com/gin-gonic/gin) web framework; 
...
Then import the validator package into your own code.
	...
	import "github.com/bingoohuang/valid"
...
Validator only InvalidValidationError for bad validation input, nil or ValidationErrors as type error; so, 
in your code all you need to do is check if the error returned is not nil, and if it's not check if error 
...
Please see https://godoc.org/github.com/bingoohuang/valid for detailed usage docs.

##### Examples:

- [Simple](https://github.com/bingoohuang/valid/blob/master/_examples/simple/main.go)
- [Custom Field Types](https://github.com/bingoohuang/valid/blob/master/_examples/custom/main.go)
- [Struct Level](https://github.com/bingoohuang/valid/blob/master/_examples/struct-level/main.go)
- [Translations & Custom Errors](https://github.com/bingoohuang/valid/blob/master/_examples/translations/main.go)
- [Gin upgrade and/or override validator](https://github.com/bingoohuang/valid/blob/_examples/gin-binding)
...
goos: darwin
goarch: amd64
pkg: github.com/bingoohuang/valid
