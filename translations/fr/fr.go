...
func RegisterDefaultTranslations(v *valid.Validate, trans ut.Translator) (err error) {
	translations := []struct {
		tag             string
		translation     string
		override        bool
		customRegisFunc valid.RegisterTranslationsFunc
		customTransFunc valid.TranslationFunc
	}{
		{
			tag:         "required",
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe valid.FieldError) string {
				var err error
				var t string
...
func registrationFunc(tag string, translation string, override bool) valid.RegisterTranslationsFunc {
...
func translateFunc(ut ut.Translator, fe valid.FieldError) string {
