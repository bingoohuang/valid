...
type User struct {
	...
	Email          string     `json:"e-mail" valid:"required,email"`
...
func main() {
	...
	va.RegisterStructValidation(UserStructLevelValidation, User{})
...
func UserStructLevelValidation(sl valid.StructLevel) {
